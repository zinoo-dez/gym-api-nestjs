...
export function ClassFormModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" role="dialog" aria-modal="true">
      ...
      <section className="relative z-10 max-h-[92vh] w-full max-w-3xl overflow-hidden rounded-lg border bg-card text-card-foreground shadow-lg">
        <header className="flex items-start justify-between border-b px-4 py-4 md:px-6">
          <div className="space-y-1">
            <h2 className="section-title text-lg md:text-xl">{modalTitle}</h2>
            <p className="small-text">Set class details, instructor assignment, and recurrence.</p>
          </div>
        ...
        <form className="max-h-[calc(92vh-70px)] overflow-y-auto p-4 md:p-6" onSubmit={(event) => void handleSubmit(event)}>
