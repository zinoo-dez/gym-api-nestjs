...
type MemberWithRelations = Member & {
    user: User;
    subscriptions?: Array<Subscription & { membershipPlan: MembershipPlan | null }>;
};
...
export class MembersService {
    ...
    async getBookings(memberId: string, currentUser?: CurrentUserPayload): Promise<any[]> {
    ...
    toResponseDto(member: MemberWithRelations): MemberResponseDto {
        ...
        return {
            ...
            address: member.user.address ?? undefined,
            avatarUrl: member.user.avatarUrl ?? undefined,
            dateOfBirth: member.dateOfBirth ?? undefined,
            gender: member.gender ?? undefined,
            height: member.height ?? undefined,
            currentWeight: member.currentWeight ?? undefined,
            targetWeight: member.targetWeight ?? undefined,
