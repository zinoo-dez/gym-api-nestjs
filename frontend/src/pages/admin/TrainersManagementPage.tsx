...
const toErrorMessage = (error: unknown) =>
    getApiErrorMessage(error, "Unable to complete trainer request.");
            ...
            {loadState === "ready" ? (
                <>
                    <section className="space-y-4">
                        <h2 className="text-lg font-bold text-foreground">Trainer Overview</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-lg font-bold text-foreground">Trainer Directory</h2>
