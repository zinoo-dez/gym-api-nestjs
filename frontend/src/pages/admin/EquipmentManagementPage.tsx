...
const toErrorMessage = (error: unknown) =>
    getApiErrorMessage(error, "Unable to complete equipment request.");
...
export function EquipmentManagementPage({ view = "all" }: EquipmentManagementPageProps) {
    ...
    const clearFilters = () => {
        ...
        if (isListPage) {
            navigate("/app/management/equipment/list", { replace: true });
        }
    };
    ...
    const handleOverviewCardClick = (filter: QuickFilter) => {
        if (isOverviewPage) {
            ...
            navigate(`/app/management/equipment/list${query}`);
            return;
        }
        ...
        <div className="space-y-8">
            <header className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                ...
                <div className="flex gap-2">
                    {isOverviewPage ? (
                        <Button type="button" variant="outline" onClick={() => navigate("/app/management/equipment/list")}>
                            View List
                        </Button>
                    ) : null}
                ...
                <>
                    {showOverviewSection ? (
                        <section className="space-y-4">
                            <h2 className="text-lg font-bold text-foreground">Equipment Overview</h2>
                    ...
                    {showListSection ? (
                        <section className="space-y-4">
                            <div className="flex items-center justify-between">
                                <h2 className="text-lg font-bold text-foreground">Equipment List</h2>
