...
import { Prisma, UserRole, type WorkoutPlan, type Member, type User } from '@prisma/client';
import { NotificationsService } from '../notifications/notifications.service';
import { WorkoutGoal } from '../common/enums';

type WorkoutPlanWithMember = WorkoutPlan & {
...
export class WorkoutPlansService {
    ...
    private toResponseDto(workoutPlan: WorkoutPlanWithMember): WorkoutPlanResponseDto {
        let exercises;
        ...
        return {
            ...
            goal: workoutPlan.goal as WorkoutGoal,
    ...
    private validateExerciseOrder(exercises: Array<{ order: number }>): void {
