...
interface SaleMutationContext {
    snapshots: Array<[QueryKey, ApiPaginatedResponse<ProductRecord> | undefined]>;
}
...
export const useCreateSaleMutation = () => {
    ...
    return useMutation<SaleRecord, unknown, CreateSaleInput, SaleMutationContext>({
        ...
        onMutate: async (payload) => {
            ...
            const snapshots = queryClient.getQueriesData<ApiPaginatedResponse<ProductRecord>>({
            ...
            for (const [queryKey, cachedPage] of snapshots) {
                ...
                queryClient.setQueryData<ApiPaginatedResponse<ProductRecord>>(queryKey, {
                    ...cachedPage,
