...
export class MembershipsController {
    ...
    async freezeMembership(@Param('id') id: string, @CurrentUser() user: CurrentUserPayload) {
    ...
    async unfreezeMembership(@Param('id') id: string, @CurrentUser() user: CurrentUserPayload) {
    ...
    async cancelMembership(@Param('id') id: string, @CurrentUser() user: CurrentUserPayload) {
