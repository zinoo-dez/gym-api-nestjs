import api from "./api";
import type { ApiPaginatedResponse } from "./api.types";
...
import { isRecord, toNumber, asString as toStringOrUndefined, asBoolean as toBooleanOrUndefined, unwrapPayload } from "@/lib/type-guards";

const unwrapData = (value: unknown): unknown => unwrapPayload(value, 1);
...
export const paymentsService = {
    ...
    async listPayments(
        filters: PaymentsQueryFilters = {},
    ): Promise<ApiPaginatedResponse<PaymentTransaction>> {
