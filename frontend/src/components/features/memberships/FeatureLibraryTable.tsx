        ...
        <table className="min-w-full border-collapse text-left">
          <thead>
            <tr className="border-b border-border bg-card">
              <th className="px-4 py-4 text-sm font-bold text-muted-foreground">Feature Name</th>
              <th className="px-4 py-4 text-sm font-bold text-muted-foreground">Description</th>
              <th className="px-4 py-4 text-sm font-bold text-muted-foreground">Status</th>
              <th className="px-4 py-4 text-sm font-bold text-muted-foreground">Assigned Plans</th>
              ...
              <tr key={feature.id} className="border-b transition-colors hover:bg-muted/50 last:border-0">
                <td className="px-4 py-4 align-middle">
                  <div className="space-y-0.5">
                    ...
                    {feature.isSystem ? (
                      <p className="text-xs font-medium text-primary">System Feature</p>
                    ) : null}
                  </div>
                </td>
                <td className="px-4 py-4 align-middle text-sm text-muted-foreground">{feature.description || "-"}</td>
                <td className="px-4 py-4 align-middle">
                  <FeatureStatusBadge status={feature.status} />
                </td>
                <td className="px-4 py-4 align-middle text-sm text-foreground font-medium">{feature.assignedPlans}</td>
                <td className="px-4 py-4 align-middle">
