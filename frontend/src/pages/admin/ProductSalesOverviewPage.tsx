...
export function ProductSalesOverviewPage() {
    ...
    return (
        <div className="space-y-8">
            <header>
                <h1 className="text-3xl font-bold text-foreground">Product Sales Overview</h1>
            </header>
            ...
            <Card>
                ...
                <CardContent className="grid gap-3 md:grid-cols-3">
                    <Button
                        ...
                        onClick={() => void navigate("/app/management/products/management")}
                    >
                    ...
                    <Button
                        ...
                        variant="outline"
                        className="justify-start shadow-sm"
                        onClick={() => void navigate("/app/management/products/history")}
                    >
