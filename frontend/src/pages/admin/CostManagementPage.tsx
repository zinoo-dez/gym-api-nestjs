                ...
                {upcomingDueCosts.length === 0 ? (
                  ...
                  <div className="overflow-x-auto rounded-lg border bg-card">
                    <table className="min-w-full border-collapse text-sm">
                      ...
                      <tbody>
                        {upcomingDueCosts.slice(0, 8).map((cost) => (
                          <tr key={cost.id} className="border-b transition-colors hover:bg-muted/50 last:border-0">
                            <td className="px-4 py-3 text-foreground">{cost.title}</td>
                            <td className="px-4 py-3 text-foreground">{cost.vendor || "-"}</td>
                            <td className="px-4 py-3 text-foreground">{formatDisplayDate(cost.dueDate)}</td>
