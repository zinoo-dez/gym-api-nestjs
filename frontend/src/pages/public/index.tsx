                ...
                <main className="space-y-24 pb-12 pt-12 sm:space-y-28" id="home">
                    ...
                    >
                        <motion.div variants={itemVariants} className="fade-in slide-up space-y-3 text-center">
                            <h2 className="text-lg font-bold text-foreground">Equipment & Programs</h2>
                    ...
                    >
                        <motion.div variants={itemVariants} className="fade-in slide-up space-y-3 text-center">
                            <h2 className="text-lg font-bold text-foreground">Professional Trainers</h2>
                            <p className="body-text mx-auto max-w-2xl text-muted-foreground">
                        ...
                        <motion.div variants={itemVariants} className="fade-in slide-up flex flex-col items-center justify-between gap-4 rounded-2xl border bg-card p-6 md:flex-row">
                            ...
                            <div className="inline-flex rounded-full border border-input bg-background p-1">
                                <button
                                    ...
                                    className={`rounded-full px-4 py-2 small-text transition-colors ${billingCycle === "monthly" ? "bg-primary text-primary-foreground" : "text-muted-foreground"
                                        }`}
                                >
                                    Monthly
                                </button>
                                <button
                                    ...
                                    className={`rounded-full px-4 py-2 small-text transition-colors ${billingCycle === "yearly" ? "bg-primary text-primary-foreground" : "text-muted-foreground"
                                        }`}
                                >
                                    Yearly
                                </button>
                                ...
                                activePlans.map((plan, i) => {
                                    ...
                                    return (
                                        <motion.article
                                            key={plan.id}
                                            variants={itemVariants}
                                            className={`fade-in slide-up rounded-2xl border p-6 shadow-sm ${isRecommended ? "bg-primary text-primary-foreground" : "bg-card text-card-foreground"
                                                }`}
                                        >
                                            <div className="space-y-2">
                    ...
                    >
                        <motion.div variants={itemVariants} className="space-y-4">
                            <h2 className="text-lg font-bold text-foreground">Ready to make a change?</h2>
